...
public class SwiftLexer: SourceCodeRegexLexer {
	...
	lazy var generators: [TokenGenerator] = {
		...
		generators.append(regexGenerator("(?<=\\.)[A-Za-z_]+\\w*", tokenType: .instanceVariable))
